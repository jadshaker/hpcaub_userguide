...
.. todo:: embed the FileZilla screencast here once it is uploaded. It walks through a
    transfer end to end: connecting to Octopus over ``sftp://``, uploading a file by
    dragging it to the remote side and downloading a file back to the local machine.
